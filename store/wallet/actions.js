import {
  ...
  delegate, undelegate, getDelegates,
  addProposal, getProposalInfoById,
  doVote, getVoteThreshold, getReceipt, executeVoting, voteResults, getChairpersonHash, hasRole, getProposalThreshold,
} from '~/utils/wallet';
